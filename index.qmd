...
Stata、Python、R 都是这条主线上可以替换的零件。课上每个模块都会回到这张图：先想清楚要解决什么问题，再决定用哪种工具、交给谁做、如何检查。
...
2. **想复现课堂演示** → 下载本仓库的 `demo/` 文件夹，按其中的 `README.md` 操作，在文件夹内启动 Claude Code 或 Codex，即可重跑课堂上的 Agent 分析演示。
